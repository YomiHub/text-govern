...
/**
 * Load built-in baseline rules from config/*.default.xlsx.
 * These come from public open-source lexicons (konsheng/Sensitive-lexicon etc.)
 * and are only loaded when config.rules.includeDefaults = true.
 *
